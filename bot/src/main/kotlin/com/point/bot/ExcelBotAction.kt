...
private const val EXCEL_PROMPT =
    "Извлеки табличные данные из объекта (фото может быть повёрнуто или под углом — читай " +
        "внимательно в любой ориентации). Верни ТОЛЬКО JSON: массив строк, каждая строка — массив " +
        "ячеек-строк, например [[\"Имя\",\"Сумма\"],[\"Приказ\",\"42\"]]. Если ячейку не разобрать — " +
        "оставь пустой (\"\"), не ставь \"?\"; нечитаемую строку пропусти. Без пояснений."
