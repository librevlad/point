 ...
 * до сих пор задавало имя класса по алфавиту — `DropLinkRealizer` стоял впереди
 * `RemotePcRealizer` случайно, и переименование класса меняло, кто делает работу. Теперь
 * там правило: своё делается своими руками, сосед по кругу идёт раньше чужого сервиса.
 *
