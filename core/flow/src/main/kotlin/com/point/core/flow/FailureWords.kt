...
/** Вся фраза целиком, а не одна её голова: собирают её обе поверхности одинаково (#1272). */
fun investigationFailedNote(reason: String): String = "$INVESTIGATION_FAILED_HEAD: $reason"
