 ...
 *
 * Одна константа на все пред-проверки и на сводку отказов (#1237): у чтения снаружи,
 * у цепочки моделей и у связи с компьютером было по своей фразе, и человек читал про
 * одну и ту же выключенную сеть три разных истории.
 */
