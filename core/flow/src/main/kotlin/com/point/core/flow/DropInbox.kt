...
// Причина называет причину, а не место, где её чинить: дверь стоит рядом на самом экране,
// и «войдите в настройках» рядом с кнопкой «Войти» спорило само с собой (#897).
