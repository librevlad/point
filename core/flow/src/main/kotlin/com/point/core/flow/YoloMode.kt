 ...
 * режимом работы». Чего она не разрешает — подразумевать согласие по умолчанию, поэтому в
 * релизной сборке режим выключен, пока его не включили руками. В сборках для своих
 * (`debug`, `dogfood`) он включён сразу: там человек — сам разработчик, и он это выбрал.
 *
...
const val YOLO_WHAT =
    "Не спрашивать разрешения на облако и всегда брать самый сильный путь: облачные " +
        "исполнители и зрячие модели идут первыми. Объект уходит наружу без вопроса."
