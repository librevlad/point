...
object PhoneNumbers {
     ...
     * человек и так знает (#1129). Дописать код, которого в документе нет, она не может:
     * страна на экране всегда та же, что в графе, и на любом устройстве одна и та же —
     * меняется только то, повторять ли её.
     */
