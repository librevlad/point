 ...
 * - слово у самого действия (`ActionYield.New` со своим `noun`) — предупреждение или обещание
 *   по существу: «картинку · дольше, зато на устройстве». Когда дорога зависит от того, кто
 *   исполняет, слово даёт исполнитель, а способность его только несёт (#1021): чтению снимка
 *   телефон пишет «сначала на телефоне, потом спрошу про сервис», компьютер — «уйдёт в сервис»;
