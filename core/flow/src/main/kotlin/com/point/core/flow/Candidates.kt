 ...
 * - [ARITHMETIC] — числа согласованы между собой, и это проверяемо без страницы: контрольная
 *   цифра S10 сошлась ([formEvidence]) либо расчёт сошёлся с напечатанным итогом
 *   ([arithmeticTotals], #262). Класс независим от формы по построению: форма говорит «так пишут
 *   такие значения», арифметика — «эти цифры сходятся друг с другом».
 */
