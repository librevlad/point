 ...
 *
 * Живёт в `:core:flow`, а не в `:data` (#585): читать docx нужно и телефону, и компьютеру, а кода
 * здесь ровно столько, сколько есть в JDK, — zip и регулярка. Пока класс лежал в `:data`, ПК не
 * умел прочитать присланный документ вовсе, хотя всё для этого у него было.
 */
