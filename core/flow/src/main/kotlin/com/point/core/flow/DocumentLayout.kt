...
/**
 * Сколько страниц набора остались непрочитанными (#1207, #1243).
 *
 * Отказавшиеся — прочитать не вышло — и не начатые: те, до которых заход не дошёл, упершись
 * в предел страниц или в отведённое ему время. Место и тех, и других помечено в самой таблице.
 */
