 ...
 * «20842 кВт» он пропустит суммой — так же, как пропускал до #1059. Это гейт «число ли это»,
 * а не «какая это валюта»; живой дефект карточки — буквы **перед** числом — закрыт отдельно.
 */
