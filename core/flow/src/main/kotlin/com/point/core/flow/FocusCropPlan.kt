 ...
 *
 * Замер 04.08.2026 (`docs/VISION-MODELS.md`): показания приборов — ноль из трёх, и провал там
 * опаснее отказа: модель уверенно отдаёт числа с шильдика, и человек получает показание,
 * которого не было. Причина не в качестве чтения, а в вопросе — страница целиком неправильный
 * вопрос, когда нужное занимает считанные проценты кадра.
 *
