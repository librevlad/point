...
private val PROCESS_NOTES: Set<String> = setOf(
    ...
    // Каким кадром смотрели — выпрямленным или тем, что дал человек (#1041): тот же след
    // работы, что и увеличение. Сам по себе он ничего не рассказывает о снимке, и вопрос
    // «что написано» им не закрывается.
    META_READ_STRAIGHTENED,
