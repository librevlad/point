...
class MoneyAmountTest {
    ...
    @Test
    fun `итог сверяется по напечатанным знакам, а не по всем`() {
        // «127*4.32» даёт 548,6400; страница пишет «548,64» — это то же число, записанное так,
        // как записывают деньги. Требовать полного совпадения значило бы не читать копейки вовсе.
