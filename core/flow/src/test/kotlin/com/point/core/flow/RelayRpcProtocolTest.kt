 ...
 *
 * Ящик релея публичный: в него может прилететь протухший ответ на прошлый запрос или просто
 * мусор. Принять первое попавшееся — значит показать человеку чужой результат как свой (#272).
 */
