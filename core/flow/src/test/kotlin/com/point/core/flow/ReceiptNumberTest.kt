...
class ReceiptNumberTest {
    ...
    fun `порченое движком слово — то же слово`() {
        // Дословный вывод устройства на кадре 20: «Квитанція №» пришло как «Квитанщя №» —
        // движок слепил «ці» в одну букву. Свёртка лечит съеденную букву и бессильна против
        // слипшихся, поэтому стем кончается там, где кончается целое: «квитан».
        assertTrue(looksLikeReceiptMarker("Квитанщя"))
        assertEquals(
            "AB12-CD34-EF56-GH78",
            receiptFacts("Квитанщя № AB12-CD34-EF56-GH78 Big 26.04.2026")[META_ENTITY_RECEIPT],
        )
        // Порча буквы не отменяет остального: слово по-прежнему обязано быть на странице.
