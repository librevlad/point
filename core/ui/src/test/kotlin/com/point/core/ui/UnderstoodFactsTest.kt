...
/** The «Point понял» checklist (#114) is derived purely from the object — JVM-testable. */
class UnderstoodFactsTest {
    ...
    fun `orders facts stably and pairs labels with values`() {
        ...
        assertEquals("github.com/librevlad", facts[1].value) // scheme stripped for reading
    }
