...
data class Bubble(
     ...
     * строки обычно нет (#582), а не прячет действие (решение владельца — «дверь не
     * исчезает»). Одно исключение названо владельцем 21.08.2026: читать себя негодный
     * объект не предлагает, и двери чтения до этого списка не доходят (#994).
     */
