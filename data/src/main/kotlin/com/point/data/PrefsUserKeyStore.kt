...
/**
 * App-private [SharedPreferences] (sandboxed to this app): no other app can read
 * the key and it never leaves the device. Blank key ⇒ not configured. Encryption
 * at rest (EncryptedSharedPreferences) is a later hardening; app-private storage is
 * the standard bar for a personal API key on-device.
 */
