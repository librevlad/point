...
/**
 * Наружу уходит EXIF-выпрямленная и ограниченная копия — **та же самая**, которую читает
 * офлайновый движок.
 *
...
class BitmapOutboundFrames @Inject constructor() : OutboundFrames {
    ...
    private companion object {
        /** Та же граница длинной стороны, что у офлайнового движка: один вход — два чтения. */
