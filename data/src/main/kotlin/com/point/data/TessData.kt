 ...
 * ([TesseractTextRecognizer]) и табло прибора. Второго больше нет (#396: прибор читается обычным
 * распознаванием), читатель снова один, и файл остаётся ровно затем же: список моделей живёт в
 * одном месте, а не расходится молча по копиям процедуры.
 */
