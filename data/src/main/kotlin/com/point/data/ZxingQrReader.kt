...
// одну беду дважды. Читатели кодов и движок отделения от фона получают путь к снимку,
// а не объект, поэтому вид здесь задан контрактом — изображение (#1033, #992). Сигнал
// назван: байты не разобрались в снимок, и это про сам объект — молчанием такое не
// передать (#1258).
