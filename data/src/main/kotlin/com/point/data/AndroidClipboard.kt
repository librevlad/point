...
/** Writes to the system clipboard from the application context. Called on an explicit user tap
 *  (Point is foreground), so the Android 10+ background-write restriction doesn't apply. */
