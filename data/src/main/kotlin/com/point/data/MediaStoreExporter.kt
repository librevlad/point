...
/**
 * Exports an object to the public Downloads collection via MediaStore on API 29+
 * (no runtime permission under scoped storage). On older APIs it falls back to
 * the app-specific external Downloads dir (also permission-free).
 */
