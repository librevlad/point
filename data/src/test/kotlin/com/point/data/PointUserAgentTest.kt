...
/**
 * Каждый исходящий запрос называет себя.
 *
 * Проверять тут есть что, и цена ошибки известна: без этого заголовка Groq и Cerebras отвечали
 * 403 — не «кончилась квота», не «плохой ключ», а «неизвестно кто». Замер 04.08.2026 поймал их
 * живыми, стоило запросу представиться.
 */
