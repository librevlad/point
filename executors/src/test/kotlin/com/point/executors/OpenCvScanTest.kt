...
/**
 * Corner ordering is the classic perspective-warp bug (a swapped corner mirrors the page).
 * [org.opencv.core.Point] is pure Java, so the geometry runs on the JVM without the native lib.
 */
class OpenCvScanTest {
    ...
    fun `orderCorners sorts any input into tl, tr, br, bl`() {
        ...
        val ordered = OpenCvScan.orderCorners(arrayOf(br, tl, bl, tr)) // scrambled
