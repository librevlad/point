 ...
 *
 * Это сторож шва, а не доказательство починки: три исполнителя вели себя так и до #992 —
 * беда жила слоем ниже, в `:data`, где слова были прибиты к вырезу. Здесь заперто то, что
 * ломать нельзя впредь; сам слой проверяет `BackgroundEngineIsSealedTest`.
 */
