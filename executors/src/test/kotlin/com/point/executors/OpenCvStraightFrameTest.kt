 ...
 *
 * Пакета обработки снимков может не быть на устройстве: ровно этим `ScanPlusRealizer`
 * объясняет человеку, почему «Скан с цветом» недоступен. Чтение на таком устройстве обязано
