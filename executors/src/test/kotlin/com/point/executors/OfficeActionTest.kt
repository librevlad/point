...
/**
 * «Извлечь текст» (#288): реализатор был без покрытия, а разбор docx/xlsx идёт секунды — тем же
 * извлекателем, который в «В PDF» уже рассказывал о себе. Соседний пузырёк над тем же документом
 * не имеет права молчать: разная разговорчивость читается не как «этот проще», а как «этот завис».
 */
