 ...
 */
class SlidesCapabilityOnPhone @Inject constructor() : Capability {
    private val inner = com.point.core.flow.SlidesCapability()
...
class SlidesRealizerOnPhone @Inject constructor(
    store: ObjectStore,
    officeText: OfficeTextExtractor,
) : Realizer {
    private val inner = com.point.core.flow.SlidesRealizer(store, officeText)
