 ...
 * [receiptFacts]), и оно слепо ровно там, где кадр корпуса и живёт, — сумма внутри расчёта
 * «127*4.32=548,64» валюты рядом не имеет вовсе. SUBJECT правила не имеет **никакого**: тема
