 ...
 */
class ExtractAllCapabilityOnPhone @Inject constructor() : Capability {
    private val inner = com.point.core.flow.ExtractAllCapability()
...
class ExtractAllRealizerOnPhone @Inject constructor(
    store: ObjectStore,
    extractor: EntityExtractor,
) : Realizer {
    private val inner = com.point.core.flow.ExtractAllRealizer(store, extractor)
