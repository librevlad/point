 ...
 */
class FindCapabilityOnPhone @Inject constructor() : Capability {
    private val inner = com.point.core.flow.FindCapability()
...
class FindRealizerOnPhone @Inject constructor() : Realizer {
    private val inner = com.point.core.flow.FindRealizer()
