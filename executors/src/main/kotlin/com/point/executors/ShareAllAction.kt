...
/** COLLECTION -> one system share sheet with every file. Terminal. The share-all
 *  sibling of [SaveAllCapability]; both operate on the whole collection. */
class ShareAllCapability @Inject constructor() : Capability {
    override val id = ID
    override val icon = "share" // reuses the share glyph; the label says "всем"
