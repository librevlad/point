 ...
 */
class PagesCapabilityOnPhone @Inject constructor() : Capability {
    private val inner = com.point.core.flow.PagesCapability()
...
class PagesRealizerOnPhone @Inject constructor(
    rasterizer: PdfRasterizer,
) : Realizer {
    private val inner = com.point.core.flow.PagesRealizer(rasterizer)
