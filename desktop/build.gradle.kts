    ...
    application {
        ...
        nativeDistributions {
            ...
            windows {
                ...
                // Своим именем, а не «Unknown». Без этого jpackage кладёт ярлык в папку меню
                // «Пуск» с таким названием — и человек ищет Point там, где написано, что
                // программа неизвестна.
                menuGroup = "Point"

                // Один и тот же продукт от версии к версии. Без этого номера Windows не
                // видит в новом установщике обновление старого: установка упирается в
                // «уже установлено» (1638), и прежний Point приходится сносить руками.
                upgradeUuid = "6f2b1c34-4d5e-4a7b-9c81-2f0a5e7d3b64"
            }
        }
    }
}
