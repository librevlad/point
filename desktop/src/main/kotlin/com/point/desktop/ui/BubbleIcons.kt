...
/*
 * Порт `core/ui/BubbleIcons.kt` (#626-соседнее).
 *
 * Источник правды — телефонный файл: у Android-UI и Compose Desktop нет общего модуля, а
 * одинаковая иконка и одинаковый цвет действия — половина ощущения одного продукта. Меняется
 * там — переносится сюда; расходиться им нельзя.
 */
