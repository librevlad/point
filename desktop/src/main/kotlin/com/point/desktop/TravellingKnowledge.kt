 ...
 * (исходящий объект) и `DesktopState.lateOutcomeMeta` → `Outbox.addOutcome` (исход работы,
 * не уложившейся в бюджет ответа). Первые два делали эту замену каждое своей копией правила,
