...
/**
 * Read/write the PC's system clipboard as a [ClipboardPayload] for «общий буфер» (#161 slice 2):
 * text, a copied file (Explorer), or a screenshot (image) all cross. Files win over images over text
 * when several representations are present.
 */
