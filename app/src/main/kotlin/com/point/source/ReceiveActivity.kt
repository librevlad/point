...
class ReceiveActivity : ComponentActivity() {
    ...
    /** Вход живёт своим экраном — отсюда ведём прямо туда. */
...
private fun ReceiveScreen(
    ...
    Column(
        ...
        when {
            ...
            // плашка и «Отмена». Теперь причина стоит под именем экрана, а рядом — действие,
            // которое эту причину снимает (#897).
            failure != null -> {
                ScreenHeader(
