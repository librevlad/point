 ...
 *
 * Записывает чужое приложение, поэтому `RECORD_AUDIO` Point не просит. Что записанное умеет Point
 * сегодня: сохранить и переслать. «Понять» голос пока нельзя — разбор `ogg` открыт в #223, и
