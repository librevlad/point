...
class HomeDoorsTest {
    ...
    @Test fun `подзаголовок досказывает то, чего нет в заголовке`() {
        // Заголовок назвал смысл («Покупка») — подзаголовок говорит, что это был за файл.
        assertEquals("чек.png · 3 часа назад", historySubtitle("чек.png", "Изображение", "3 часа назад"))
