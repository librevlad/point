...
class FlowViewModelTest {
     ...
     * и на большом снимке или на медленном устройстве человек ждал у объекта минутами: что
     * Point занят, видно было по погасшим действиям, а сколько уже ждёшь и как остановить —
     * нет. Здесь действие быстрое по объявлению, но прогон затянулся: счёт ожидания и
     * «Отменить» обязаны прийти к любому.
     */
