 ...
 *
 * Сюда приезжают две двери: «Ключ AI сохранён» и «Объект недоступен» из истории. Раньше
 * на этом экране не было ни одной кнопки, а «назад» закрывал Point: удача заканчивалась
